    ...
    <div className="h-full w-full relative">
      ...
      <div className="absolute top-0 left-0 h-full w-full z-40 flex flex-col justify-center items-center text-white gap-y-5">
        <h1 className="font-bold text-8xl text-center">
          Your trusted partners in event creation <br />
        </h1>
        <h3 className="text-4xl text: decoration-slate-50 italic ">
          Get the world talking about your events
        </h3>
        <button
          type="submit"
          className="text-black bg-white rounded-3xl w-40 h-10 font-extrabold mt-7"
        >
          Create an Event
        </button>
      </div>
